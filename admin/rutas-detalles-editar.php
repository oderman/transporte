...
<?php
$consultaPpal = $pdo->prepare("SELECT * FROM rutas_vehiculos WHERE rutv_id='".$_GET["idR"]."'");
		...
		<div class="page-wrapper">
			...
			<div class="page-content">
				...
				<div class="main-container">
					...
					<form id="form_subir" action="rutas-detalles-actualizar.php" method="post" enctype="multipart/form-data">
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<select class="form-control selectpicker" data-live-search="true" id="vehiculo" name="vehiculo" required>
												...
												?>
													<option value="<?=$datos['veh_id'];?>" <?php if($datosPpal['rutv_vehiculo'] == $datos['veh_id']) {echo "selected";}?>><?=$datos['veh_nombre'];?></option>
												<?php }?>
											</select>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control form-control-sm" id="tarifa" name="tarifa" value="<?=$datosPpal['rutv_tarifa'];?>" required>
										</div>
									</div>
