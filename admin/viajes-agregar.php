		...
		<div class="page-wrapper">
			...
			<div class="page-content">
				...
				<div class="main-container">
					...
					<form id="form_subir" action="viajes-guardar.php" method="post" enctype="multipart/form-data">
					...
					<div class="row gutters">
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<select class="form-control selectpicker" data-live-search="true" id="trayecto" name="trayecto" required>
												...
												?>
													<option value="<?=$datos['rutv_id'];?>"><?=$datos['veh_nombre'];?> - DE <?=$origen['ciu_nombre']." A ".$datos['ciu_nombre']." ($".number_format($datos['rutv_tarifa'],0,".",".").")";?></option>
												<?php }?>
											</select>
										</div>
									</div>
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-right">
							<button type="submit" class="btn btn-outline-primary btn-lg"><span class="icon-save1"></span> CONTINUAR</button>
						</div>
