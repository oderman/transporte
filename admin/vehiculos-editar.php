...
<?php
$consultaPpal = $pdo->prepare("SELECT * FROM vehiculos WHERE veh_id='".$_GET["idR"]."'");
		...
		<div class="page-wrapper">
			...
			<div class="page-content">
				...
				<div class="main-container">
					...
					<form id="form_subir" action="vehiculos-actualizar.php" method="post" enctype="multipart/form-data">
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control form-control-sm" id="nombre" name="nombre" value="<?=$datosPpal['veh_nombre'];?>" required>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control form-control-sm" id="placa" name="placa" value="<?=$datosPpal['veh_placa'];?>" required>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control form-control-sm" id="consumo" name="consumo" value="<?=$datosPpal['veh_consumo'];?>" required>
										</div>
									</div>
