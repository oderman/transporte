		...
		<div class="page-wrapper">
			...
			<div class="page-content">
				...
				<div class="main-container">
					...
					<form id="form_subir" action="rutas-guardar.php" method="post" enctype="multipart/form-data">
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<select class="form-control selectpicker" data-live-search="true" id="origen" name="origen" required>
												...
												?>
													<option value="<?=$datos['ciu_id'];?>"><?=$datos['ciu_nombre'].", ".$datos['dep_nombre'];?></option>
												<?php }?>
											</select>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control form-control-sm" id="distancia" name="distancia" required>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<select class="form-control selectpicker" data-live-search="true" id="tiempo" name="tiempo" required>
												...
												<option value="5">Cuarto de día</option>
											</select>
										</div>
									</div>
